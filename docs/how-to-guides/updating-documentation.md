...
The website is generated using [Material for MkDocs](https://squidfunk.github.io/mkdocs-material) and can be viewed at [homelab.kre80r.com](https://homelab.kre80r.com).
...
It's running on my other cluster in the [kre80r/horus](https://github.com/kre80r/horus) project
(so if the homelab goes down everyone can still read the documentation).

<!-- TODO -->
<!-- This website is running in both my homelab cluster and on my other cluster in the [kre80r/horus](https://github.com/kre80r/horus) project (both in `apps/homelab-docs`), -->
...
<!-- - Find the TXT record for `homelab.kre80r.com` and switch the `ownerID` between `homelab` and `horus` -->
