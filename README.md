...
**[Features](#features) • [Get Started](#get-started) • [Documentation](https://homelab.kre80r.com)**

[![tag](https://img.shields.io/github/v/tag/kre80r/homelab?style=flat-square&logo=semver&logoColor=white)](https://github.com/kre80r/homelab/tags)
[![document](https://img.shields.io/website?label=document&logo=gitbook&logoColor=white&style=flat-square&url=https%3A%2F%2Fhomelab.kre80r.com)](https://homelab.kre80r.com)
[![license](https://img.shields.io/github/license/kre80r/homelab?style=flat-square&logo=gnu&logoColor=white)](https://www.gnu.org/licenses/gpl-3.0.html)
[![stars](https://img.shields.io/github/stars/kre80r/homelab?logo=github&logoColor=white&color=gold&style=flat-square)](https://github.com/kre80r/homelab)
...
- [Try it out locally](https://homelab.kre80r.com/installation/sandbox) without any hardware (just 4 commands!)
- [Deploy on real hardware](https://homelab.kre80r.com/installation/production/prerequisites) for production workload

## Roadmap

See [roadmap](https://homelab.kre80r.com/reference/roadmap) and [open issues](https://github.com/kre80r/homelab/issues) for a list of proposed features and known issues.

## Contributing

Any contributions you make are greatly appreciated.

Please see [contributing guide](https://homelab.kre80r.com/reference/contributing) for more information.
...
See [license page](https://homelab.kre80r.com/reference/license) or `LICENSE.md` file for more information.
...
[![Stargazers over time](https://starchart.cc/kre80r/homelab.svg)](https://starchart.cc/kre80r/homelab)
